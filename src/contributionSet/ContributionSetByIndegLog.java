...
public class ContributionSetByIndegLog {
	...
	public static void main(String[] args) throws NumberFormatException,
		...
		for (int i = 0; i < vertexNum; i++) {
			if (indegrees[i] < base) {
				...
				bw.write(i + "\t" + Math.log(indegrees[i]) / Math.log(base)
						+ "\n");
			}
		}
		bw.close();
		System.out.println("contribution setting by indeglog" + base + " is finished!!");
	}
