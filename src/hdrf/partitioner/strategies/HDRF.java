...
package hdrf.partitioner.strategies;

import hdrf.core.Edge;
import java.util.LinkedList;
import java.util.Random;
import hdrf.partitioner.PartitionState;
import hdrf.partitioner.coordinated_state.CoordinatedPartitionState;
import hdrf.partitioner.PartitionStrategy;
import hdrf.partitioner.Record;
import hdrf.application.Globals;
...
public class HDRF implements PartitionStrategy {
	...
	public void performStep(Edge e, PartitionState state) {
		...
		if (state.getClass() == CoordinatedPartitionState.class) {
			...
			// NEW UPDATE RECORDS RULE TO UPFDATE THE SIZE OF THE PARTITIONS
			// EXPRESSED AS THE NUMBER OF VERTICES THEY CONTAINS
